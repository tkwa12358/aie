...
- **音素发音说明**: 在专业评测结果中，为问题音素提供详细的发音指南
  - 包含 20 个核心音素知识库（12 个辅音 + 8 个元音）
  - 每个音素提供：名称、发音说明、示例单词、发音技巧、常见错误
  - 支持音素符号变体匹配（如 θ/th、ʃ/sh 等）
  - 自动过滤并去重显示问题音素
  - 移动端自适应显示

### 📁 新增文件

- `frontend/src/data/phoneme-guide.ts` - 音素知识库数据和查找函数
- `frontend/src/components/PhonemeHint.tsx` - 音素发音提示组件
